                ...
                <div className="staff_main">
                    ...
                    <div className="main_body">
                        <div className="side_nav">
                            <NavLink activeClassName="active_class" className="nav" to="/staff/computer_staff"> <nav>Computer engg. Section</nav></NavLink> <hr />
                        ...
                        <div className="route">
                            <Switch>
                                <Route path="/staff/computer_staff" component={Computer_staff} />
                                <Route path="/staff/civil_staff" component={Civil_staff} exact/>
